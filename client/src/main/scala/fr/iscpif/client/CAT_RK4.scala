...
object CAT_RK4 {
  ...
  def compute_CAT_RK4(zeta: Double, l: Double, g: Double, M: Double, h_C: Double,
    ...
    val k1_C = C(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi, phi2 , d , delta , mp , mt , ip, it, Cprev  , Aprev , Tprev )

    val k1_A = A(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi, phi2 , d , delta , mp , mt , ip, it, Cprev  , Aprev , Tprev )

    val k1_T = T(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi, phi2 , d , delta , mp , mt , ip, it, Cprev  , Aprev , Tprev )



    val k2_C = C(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , d , phi2, delta , mp , mt ,ip,it, Cprev + (h/2)*k1_C  , Aprev + (h/2)*k1_A , Tprev + (h/2)*k1_T )

    val k2_A = A(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , d , phi2, delta , mp , mt ,ip,it, Cprev + (h/2)*k1_C  , Aprev + (h/2)*k1_A , Tprev + (h/2)*k1_T )

    val k2_T = T(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , d , phi2, delta , mp , mt ,ip,it, Cprev + (h/2)*k1_C  , Aprev + (h/2)*k1_A , Tprev + (h/2)*k1_T )



    val k3_C = C(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , phi2, d , delta , mp , mt ,ip,it, Cprev + (h/2)*k2_C  , Aprev + (h/2)*k2_A , Tprev + (h/2)*k2_T )

    val k3_A = A(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , phi2, d , delta , mp , mt ,ip,it, Cprev + (h/2)*k2_C  , Aprev + (h/2)*k2_A , Tprev + (h/2)*k2_T )

    val k3_T = T(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , phi2, d , delta , mp , mt ,ip,it, Cprev + (h/2)*k2_C  , Aprev + (h/2)*k2_A , Tprev + (h/2)*k2_T )



    val k4_C = C(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , phi2,d , delta , mp , mt ,ip,it, Cprev + h*k3_C  , Aprev + h*k3_A , Tprev + h*k3_T )

    val k4_A = A(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , phi2,d , delta , mp , mt ,ip,it, Cprev + h*k3_C  , Aprev + h*k3_A , Tprev + h*k3_T )

    val k4_T = T(zeta, l, g , M , h_C , alpha , p , a , e , eta , eps
      , phi , phi2,d , delta , mp , mt ,ip,it, Cprev + h*k3_C  , Aprev + h*k3_A , Tprev + h*k3_T )
